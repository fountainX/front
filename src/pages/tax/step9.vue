  ...
  <div>
    ...
    <div class="desc">
      <el-descriptions :title="'订单号' + order.id" :column="2">
        ...
        <template v-if="order.companyType == 2">
          <template v-for="item in order.ruleListDataLLC">
        ...
        <template v-for="item in order.ruleListDataC">
    ...
    <div>
      <el-descriptions :column="1">
        ...
        <el-descriptions-item label="服务公司名字：">{{ invoice.companyName }}</el-descriptions-item>
    ...
    <div class="demo-image__preview">
      <el-image v-for="(item, index) in pay.voucher" style="width: 100px; height: 100px; margin: 5px" :src="item" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" :preview-src-list="pay.voucher" :initial-index="index" fit="cover" />
    </div>
