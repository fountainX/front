  ...
  <div class="container box">
    <el-row>
      ...
      <el-col :span="24">
        <div class="formArea">
          <el-card>
            <Step1 ref="step" v-if="active == 0" :order="param.order" :orderId="orderId" :orderStatus="orderStatus" :invoice="param.invoice" @update="updateOrder"></Step1>
...
const createOrder = () => {
  orderCreate({ order_status: 10, businessType: 10, creator: userInfo.uid, content: param })
    .then((res: any) => {
