...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const getRuleList = () => {
      ...
      ruleList({ page: 1, count: 20, businessType: 51, region: region, company_type: 'C' }).then((res: any) => {
      ...
      ruleList({ page: 1, count: 20, businessType: 51, region: region, company_type: 'LLC' }).then((res: any) => {
        const list = res.data.toSorted((a, b) => {
          if (a.order > b.order) {
            return 1
          } else {
