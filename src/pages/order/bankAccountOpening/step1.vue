    ...
    <el-row>
      <template v-for="(item, index) in ruleListDataC">
        <el-col :span="24" class="grid-cell">
          <el-form-item :label="item.rule_content + '：'" prop="bank_account" class="required label-right-align">
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const getRuleList = () => {
      ...
      ruleList({ page: 1, count: 20, businessType: 92, region: region, company_type: 'C' }).then((res: any) => {
      ...
      ruleList({ page: 1, count: 20, businessType: 92, region: region, company_type: 'LLC' }).then((res: any) => {
