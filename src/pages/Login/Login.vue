  ...
  <div class="login">
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="登录" name="first">
        ...
        <!-- <el-button type="primary" @click="userUpdate()">账号更新</el-button>
...
import { accountLogin, accountRegister, account, accountDelete, accountUpdate } from '@/http/api/account.ts'
...
const userLogin = () => {
  accountLogin(formLogin).then((res: any) => {
...
const userRegister = () => {
  accountRegister(formData).then((res: any) => {
    if (res.code == 200) {
...
const userUpdate = () => {
  ...
  accountUpdate(param).then((res: any) => {
    if (res.code == 200) {
...
const userDelete = () => {
  ...
  accountDelete(param).then((res: any) => {
    if (res.code == 200) {
